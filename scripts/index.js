var index = (function () {
  ...
  */
  ...
  const GENERAL_TOPICS = ["buildsystem", "porting", "tests", "thirdparty", "2d", "3d", "editor", "codestyle", "core"];
  ...
  class ReleaseNotesFormatter {
    static determineGroup(allLabels) {
      ...
      let groupName = "core"; // Extract all applied topical labels.

      let topicLabels = allLabels.filter(item => {
    ...
    static cleanupChangeMessage(groupName, message) {
      let cleanMessage = message.trim(); // Sometimes there are periods at the end.
      ...
      d: [{
        ...
        value: function _updateNotes() {
          ...
          this.pulls.forEach(pull => {
            ...
            let groupName = ReleaseNotesFormatter.determineGroup(allLabels); // Store under the determined group.
